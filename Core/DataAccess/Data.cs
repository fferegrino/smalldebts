...
new Movement { Amount = -7480.61m, Date = DateTimeOffset.Parse("12/22/2016") },
new Movement { Amount = 491.29m, Date = DateTimeOffset.Parse("08/26/2016") },
new Movement { Amount = 3034.67m, Date = DateTimeOffset.Parse("10/22/2016") },
new Movement { Amount = 8673.48m, Date = DateTimeOffset.Parse("02/10/2017") },
new Movement { Amount = -1650.55m, Date = DateTimeOffset.Parse("03/30/2016") },
new Movement { Amount = -5664.99m, Date = DateTimeOffset.Parse("04/28/2016") },
new Movement { Amount = 9029.06m, Date = DateTimeOffset.Parse("03/30/2016") },
new Movement { Amount = 1370.26m, Date = DateTimeOffset.Parse("06/04/2016") },
new Movement { Amount = -8707.55m, Date = DateTimeOffset.Parse("03/13/2016") },
new Movement { Amount = -1849.52m, Date = DateTimeOffset.Parse("05/15/2016") },
new Movement { Amount = 9144.73m, Date = DateTimeOffset.Parse("07/19/2016") },
new Movement { Amount = -8450.14m, Date = DateTimeOffset.Parse("05/30/2016") },
new Movement { Amount = -2651.97m, Date = DateTimeOffset.Parse("09/06/2016") },
new Movement { Amount = -5496.81m, Date = DateTimeOffset.Parse("02/04/2017") },
new Movement { Amount = -3254.46m, Date = DateTimeOffset.Parse("02/27/2016") },
}
		};

		public static List<Debt> Debts = new List<Debt>
		{
			new Debt { Id = "551ef9ab-0714-4b70-b887-f1290d2053c3", Name = "Ruby", Balance = -3794.11m },
			...
			new Debt { Id = "ebbb87b7-07c9-4ac5-a2fd-14e860146fe5", Name = "Brenda", Balance = 6281.1m },
